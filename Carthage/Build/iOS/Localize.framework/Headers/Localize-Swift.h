...
+ (Localize * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
...
- (NSString * _Nonnull)localizeWithKey:(NSString * _Nonnull)key tableName:(NSString * _Nullable)tableName SWIFT_WARN_UNUSED_RESULT;
/// Localize a string using your JSON File
...
/// returns:
/// localized key or same text
- (NSString * _Nonnull)localizeWithKey:(NSString * _Nonnull)key replace:(NSString * _Nonnull)replace tableName:(NSString * _Nullable)tableName SWIFT_WARN_UNUSED_RESULT;
/// Localize a string using your JSON File
...
/// returns:
/// localized key or same text
- (NSString * _Nonnull)localizeWithKey:(NSString * _Nonnull)key values:(NSArray * _Nonnull)values tableName:(NSString * _Nullable)tableName SWIFT_WARN_UNUSED_RESULT;
...
/// returns:
/// localized key or same text
- (NSString * _Nonnull)localizeWithKey:(NSString * _Nonnull)key dictionary:(NSDictionary<NSString *, NSString *> * _Nonnull)dictionary tableName:(NSString * _Nullable)tableName SWIFT_WARN_UNUSED_RESULT;
...
/// returns:
/// localized key or same text
+ (NSString * _Nonnull)localizeWithKey:(NSString * _Nonnull)key values:(NSArray * _Nonnull)replace tableName:(NSString * _Nullable)tableName SWIFT_WARN_UNUSED_RESULT;
/// Localize string with dictionary values
/// Get properties in your key with rule :property
/// If property not exist in this string, not is used.
/// \param value The replacement dictionary
...
/// returns:
/// localized key or same text
+ (NSString * _Nonnull)localizeWithKey:(NSString * _Nonnull)key dictionary:(NSDictionary<NSString *, NSString *> * _Nonnull)replace tableName:(NSString * _Nullable)tableName SWIFT_WARN_UNUSED_RESULT;
/// Return storaged language or default language in device
///
/// returns:
/// current used language
